...
export default function LoQueHacemos() {
    ...
    return (
        <div className="w-full bg-black text-white flex flex-col font-sans min-h-screen md:h-screen overflow-y-auto md:overflow-hidden scroll-smooth">
            ...
            {/* Main Content Area */}
            <main className="flex-1 flex flex-col justify-center px-6 md:px-12 lg:px-24 shrink relative z-10 py-4 md:py-2 lg:py-0 mt-6 md:mt-0 short-h-page-main">
                <div className="w-full max-w-[1300px] mx-auto">
                    <div className="flex flex-col lg:flex-row-reverse items-center gap-4 lg:gap-10">
                        ...
                        <div className="flex-1 text-left w-full">
                            ...
                            <div className="text-[10px] md:text-sm font-bold tracking-[0.2em] text-gray-400 uppercase mb-1">{t.loQueHacemos.tag}</div>
                            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-3 tracking-tight leading-[1.1] short-h-title-size">
                                {t.loQueHacemos.title}
                            </h1>
                            <p className="text-gray-300 text-sm md:text-lg leading-relaxed font-light mb-2 text-balance short-h-text-size">
                                {t.loQueHacemos.p1}
                            </p>
                            <p className="text-gray-300 text-sm md:text-lg leading-relaxed font-light mb-4 short-h-text-size">
                                {t.loQueHacemos.p2}
                            </p>
                            <ul className="text-xs md:text-base text-gray-300 space-y-2 md:space-y-4">
