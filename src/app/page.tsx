...
export default function Home() {
  ...
  return (
    <div className="min-h-screen md:h-screen w-full bg-black text-white flex flex-col font-sans overflow-y-auto md:overflow-hidden scroll-smooth">
      ...
      <ParticlesBackground />
      {/* Main Content Area */}
      <main className="flex-1 flex flex-col justify-center px-6 md:px-12 lg:px-24 relative z-20 py-2 md:py-4 lg:py-8">
        <div className="grid grid-cols-1 md:grid-cols-[1.1fr_1fr] gap-4 md:gap-8 lg:gap-16 items-center w-full max-w-[1400px] mx-auto">
          ...
          <div className="flex flex-col justify-center text-left md:pt-0">
            <h1 className="text-3xl md:text-4xl lg:text-[3.5rem] xl:text-[4rem] font-bold leading-[1.1] md:leading-[1.1] lg:leading-[1.05] tracking-tight text-white min-h-[70px] md:min-h-[80px] lg:min-h-[140px] mt-20 md:mt-0 mb-2 md:mb-4 lg:mb-8">
              <HeroTypewriter />
            </h1>
          </div>

          {/* Right Text */}
          <div className="flex flex-col space-y-2 md:space-y-4 md:pl-6 lg:pl-10 relative w-full">
